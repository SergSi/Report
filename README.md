...
#### Классический метод с окружением `figure`
...
#### Центрирование с ручной подписью
...
####  Горизонтальное расположение в `minipage`
