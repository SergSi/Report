...
### Размещение изображения: Классический метод с окружением `figure`
...
### Размещение изображения: Пользовательская команда `\insertimage`

```tex
\insertimage[width=0.5\textwidth]{images/photo.jpg}{Изображение с измененным размером}
```

### Размещение изображения: Ручное размещение с `\captionof`
...
### Размещение изображения: Центрирование с ручной подписью
...
### Размещение изображения: Горизонтальное расположение в `minipage`
